...
export default function NutritionPage({ isLoggedIn, appState, nutritionArray, setExerciseArray }) {

        console.log("nutritionArray array in nutrition page", nutritionArray)
