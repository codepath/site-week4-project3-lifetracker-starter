            ...
            <div className="chakra-stack css-1opnp10">
               <div role="group" className="chakra-form-control css-1kxonj9">
                  <div className="chakra-input__group css-bx0blc" data-group="true">
                     ...
                     <input name="email" type="email" placeholder="Email" id="field-:r0:" required aria-required="true" className="chakra-input css-trvw4f" value={email} onChange={(e) => setEmail(e.target.value)} />
                  </div>
               </div>
               <div role="group" className="chakra-form-control css-1kxonj9">
                  <div className="chakra-input__group css-bx0blc" data-group="true">
                     ...
                     <input name="username" type="text" placeholder="Username" id="field-:r1:" required aria-required="true" className="chakra-input css-trvw4f" value={username} onChange={(e) => setUsername(e.target.value)} />
                  </div>
               </div>
               <div className="css-9jay18">
                  <div role="group" className="chakra-form-control css-1kxonj9">
                     <div className="chakra-input__group css-bx0blc" data-group="true"><input type="text" name="firstName" placeholder="First name" id="field-:r2:" required aria-required="true" className="chakra-input css-qz53jc"  value={firstName} onChange={(e) => setFirstName(e.target.value)}/></div>
                  </div>
                  &nbsp;
                  <div role="group" className="chakra-form-control css-1kxonj9">
                     <div className="chakra-input__group css-bx0blc" data-group="true"><input name="lastName" type="text" placeholder="Last name" id="field-:r3:" required aria-required="true" className="chakra-input css-qz53jc" value={lastName} onChange={(e) => setLastName(e.target.value)}/></div>
                  </div>
               </div>
               <div role="group" className="chakra-form-control css-1kxonj9">
                  <div className="chakra-input__group css-bx0blc" data-group="true">
                     ...
                     <input name="password" type="password" placeholder="Password" id="field-:r4:" required aria-required="true" className="chakra-input css-67vh0" value={password} onChange={(e) => setPassword(e.target.value)} />
               ...
               <div role="group" className="chakra-form-control css-1kxonj9">
                  <div className="chakra-input__group css-bx0blc" data-group="true">
                     ...
                     <input name="passwordConfirm" type="password" placeholder="Confirm Password" id="field-:r5:" required  aria-required="true" className="chakra-input css-67vh0" value={confirmedPassword} onChange={(e) => setConfirmedPassword(e.target.value)} />
