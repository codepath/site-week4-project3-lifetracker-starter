...
<div className="tile">
  ...
  <div className="tile-image" style={{ backgroundImage: 'url(/assets/athlete-adf95577.jpg)' }}>
...
<div className="tile">
  ...
  <div className="tile-image" style={{ backgroundImage: 'url(/assets/food-e5a7cc9e.jpg)' }}>
...
<div className="tile">
  ...
  <div className="tile-image" style={{ backgroundImage: 'url(/assets/alarm-cff3823f.jpg)' }}>
...
<div className="tile">
  ...
  <div className="tile-image" style={{ backgroundImage: 'url(/assets/calendar-debf6f3b.jpg)' }}>
