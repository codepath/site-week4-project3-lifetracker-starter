...
export default function NutritionForm({isLoggedIn, appState, setNutritionArray}) {
    ...
    const handleOnSubmit = async (event) => {
        ...
        .then((response) => {
          ...
          console.log("Response:", response.data.nutritions); // Debugging console.log
        })
        .catch((error) => {
    ...
    <div className="banner-nutrition">
        <div className="chakra-stack css-1cgbrw5"><h2 className="chakra-heading css-b5coes">Nutrition</h2></div>
    </div>
                ...
                <div class="css-1hv8zgx">
                    ...
                    <div class="css-mlsaez">
                        <div class="chakra-stack css-13ra036">
                            <h2 class="chakra-heading nutrition-heading">Record Nutrition</h2>
                                    ...
                                    <div class="chakra-stack css-1db3zf7">
                                        ...
                                        <div role="group" class="chakra-form-control css-1kxonj9">
                                            ...
                                            <div class="chakra-select__wrapper css-42b2qy">
                                                <select name="category" class="chakra-select css-1gpsbw3" value={nutrition.category} onChange={handleOnInputChange}>
                                        ...
                                        <div class="css-9jay18">
                                            <div role="group" class="chakra-form-control css-1kxonj9">
                                                <label id="field-:rm:-label" for="field-:rm:" class="chakra-form__label css-g6pte">
                                                    Quantity<span role="presentation" aria-hidden="true" class="chakra-form__required-indicator css-1tfjd1n">*</span>
                                                </label>
                                            ...
                                            <div role="group" class="chakra-form-control css-1kxonj9">
                                                <label id="field-:rn:-label" for="field-:rn:" class="chakra-form__label css-g6pte">
                                                    Calories<span role="presentation" aria-hidden="true" class="chakra-form__required-indicator css-1tfjd1n">*</span>
                                                </label>
                                                <div value="" class="chakra-numberinput css-3e5t3k">
                                                    <input
                                                        name="calories"
                                        ...
                                        <button id = "button-nutrition" class="chakra-button css-4lvvxn" onClick={handleOnSubmit}>Save</button>
                                    </div>
                                </form>
                            </div>
                        </div>
